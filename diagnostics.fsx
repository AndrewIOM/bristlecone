(**
// can't yet format YamlFrontmatter (["title: Diagnostics"; "category: Techniques"; "categoryindex: 2"; "index: 5"], Some { StartLine = 2 StartColumn = 0 EndLine = 6 EndColumn = 8 }) to pynb markdown
