(**
// can't yet format YamlFrontmatter (["title: Ensembles and Parallel Processing"; "category: Techniques"; "categoryindex: 2"; "index: 4"], Some { StartLine = 2 StartColumn = 0 EndLine = 6 EndColumn = 8 }) to pynb markdown
