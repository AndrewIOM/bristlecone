...
<div><div id="e93be40e-001a-4548-9d11-d972dd4bcb2a"><!-- Plotly chart will be drawn inside this DIV --></div><script type="text/javascript">var renderPlotly_e93be40e001a45489d11d972dd4bcb2a = function() {
    ...
    Plotly.newPlot('e93be40e-001a-4548-9d11-d972dd4bcb2a', data, layout, config);
};
renderPlotly_e93be40e001a45489d11d972dd4bcb2a();
</script></div>*)
(**
#### Model selection
