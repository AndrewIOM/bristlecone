...
<div><div id="0c7527f2-1da1-4775-b4d5-e588c576fe9b"><!-- Plotly chart will be drawn inside this DIV --></div><script type="text/javascript">var renderPlotly_0c7527f21da14775b4d5e588c576fe9b = function() {
    ...
    Plotly.newPlot('0c7527f2-1da1-4775-b4d5-e588c576fe9b', data, layout, config);
};
renderPlotly_0c7527f21da14775b4d5e588c576fe9b();
</script></div>*)
(**
#### Model selection
