(**
// can't yet format YamlFrontmatter (["title: Optimisation"; "category: Components"; "categoryindex: 4"; "index: 1"], Some { StartLine = 2 StartColumn = 0 EndLine = 6 EndColumn = 8 }) to pynb markdown
