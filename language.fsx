(**
// can't yet format YamlFrontmatter (["title: Writing Models"; "category: The Bristlecone Language"; "categoryindex: 1"; "index: 2"], Some { StartLine = 2 StartColumn = 0 EndLine = 6 EndColumn = 8 }) to pynb markdown
