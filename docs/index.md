...
Bristlecone is a library that does this specific thing.  
...
<div class="row row-cols-1 row-cols-md-2">
  ...
  <div class="col">
    <div class="card h-100">
      ...
      <div class="card-footer text-right   border-top-0">
        <a href="{{siteBaseUrl}}/Api_Reference/Bristlecone/Bristlecone.html" class="btn btn-primary">Read Api Docs</a>
      </div>
    </div>
  </div>
</div>
