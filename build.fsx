...
let productName = "Bristlecone"
let sln = "Bristlecone.sln"
...
let releaseDocs ctx =
    ...
    let cmd = sprintf """commit -a -m "Update generated documentation for version %s""" latestEntry.NugetVersion
